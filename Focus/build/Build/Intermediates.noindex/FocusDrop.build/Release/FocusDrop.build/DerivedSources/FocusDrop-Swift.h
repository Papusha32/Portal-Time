...
#ifndef FOCUSDROP_SWIFT_H
#define FOCUSDROP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FocusDrop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9FocusDrop11AppDelegate")
...
@class NSEvent;
SWIFT_CLASS("_TtC9FocusDrop14DraggablePanel")
@interface DraggablePanel : NSPanel
...
SWIFT_CLASS("_TtC9FocusDrop24FloatingWindowController")
@interface FloatingWindowController : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC9FocusDrop17MenuBarController")
